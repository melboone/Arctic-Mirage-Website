<?php $description = 'Laburnum Project, Laburnum Development, Laburnum Real Estate'; ?>
<?php $keywords = 'Laburnum Project'; ?>
<?php $title = 'The Laburnum | Arctic Mirage'; include("../../includes/header.php"); ?>
    <div class="pr-desc">
    <h1>The Laburnum</h1>
...
Material Board</p>
    ...
    <div id="content_1" class="content">
        <div class="images_container">
            <img src="TAM_WebFolio20.jpg" alt="The Laburnum Tam Portfolio">
            <img src="TAM_WebFolio21.jpg" alt="The Laburnum Tam Portfolio">
            <img src="TAM_WebFolio22.jpg" alt="The Laburnum Tam Portfolio">
            <img src="TAM_WebFolio23.jpg" alt="The Laburnum Tam Portfolio">
            <img src="TAM_WebFolio24.jpg" alt="The Laburnum Tam Portfolio">
            <img src="TAM_WebFolio25.jpg" alt="The Laburnum Tam Portfolio">
            <img src="TAM_WebFolio26.jpg" alt="The Laburnum Tam Portfolio">
        </div>
    </div>
