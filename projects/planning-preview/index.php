<?php $description = 'Planning preview'; ?>
<?php $keywords = 'Planning preview'; ?>
<?php $title = 'Planning preview | Arctic Mirage'; include("../../includes/header.php"); ?>
    <div class="pr-desc">
    <h1>Planning preview</h1>
<p>Logo Design<br>
Business Card & Letterhead<br>
Website Design & Coding<br>
iPhone App</p>
</div>
    <div id="content_1" class="content">
        <div class="images_container">
            <img src="planning-preview-1.jpg" alt="">
            <img src="planning-preview-3.jpg" alt="">
        </div>
    </div>
