<?php $description = 'Evoke Apartments by Arctic Mirage Melbourne'; ?>
<?php $keywords = 'Evoke Apartments, Evoke, Apartments'; ?>
<?php $title = 'Evoke Apartments | Arctic Mirage'; include("../../includes/header.php"); ?>
    <div class="pr-desc">
    <h1>Evoke Apartments</h1>
...
Material Board</p>
    ...
    <div id="content_1" class="content">
        <div class="images_container">
            <img src="TAM_WebFolio_110.jpg" alt="">
            <img src="TAM_WebFolio_111.jpg" alt="">
            <img src="TAM_WebFolio_112.jpg" alt="">
            <img src="TAM_WebFolio_113.jpg" alt="">
            <img src="TAM_WebFolio_114.jpg" alt="">
            <img src="TAM_WebFolio_115.jpg" alt="">
        </div>
    </div>
