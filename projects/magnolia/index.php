<?php $description = 'Magnolia'; ?>
<?php $keywords = 'Magnolia'; ?>
<?php $title = 'Magnolia | Arctic Mirage'; include("../../includes/header.php"); ?>
    <div class="pr-desc">
    <h1>Magnolia</h1>
...
Hoarding Banner</p>
    ...
    <div id="content_1" class="content">
        <div class="images_container">
            <img src="magnolia-1.jpg" alt="">
            <img src="magnolia-2.jpg" alt="">
            <img src="magnolia-3.jpg" alt="">
            <img src="magnolia-4.jpg" alt="">
            <img src="magnolia-5.jpg" alt="">
            <img src="magnolia-6.jpg" alt="">
        </div>
    </div>
