<?php $description = 'Almond Apartments, almond'; ?>
<?php $keywords = 'Almond Apartments, almond'; ?>
<?php $title = 'Almond Apartments | Arctic Mirage'; include("../../includes/header.php"); ?>
    <div class="pr-desc">
    <h1>Almond Apartments</h1>
<p>3D Artist Impressions<br>
Interior Design & Specifications<br>
Logo Design<br>
...
Hoarding Banner</p>
    ...
    <div id="content_1" class="content">
        <div class="images_container">
            <img src="Almond_1.jpg" alt="">
            <img src="Almond_2.jpg" alt="">
            <img src="Almond_3.jpg" alt="">
            <img src="Almond_4.jpg" alt="">
            <img src="Almond_5.jpg" alt="">
            <img src="Almond_6.jpg" alt="">
            <img src="Almond_7.jpg" alt="">
        </div>
    </div>
