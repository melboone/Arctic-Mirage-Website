<?php $description = 'Milla Aprtments by Arctic Mirage'; ?>
<?php $keywords = 'Mila Apartments'; ?>
<?php $title = 'Milla Apartments | Arctic Mirage'; include("../../includes/header.php"); ?>
    <div class="pr-desc">
    <h1>Milla Apartments</h1>
<p>3D Artist Impressions</p>
</div>
    <div id="content_1" class="content">
        <div class="images_container">
            <img src="Milla1.jpg" alt="">
             <img src="Milla2.jpg" alt="">
              <img src="Milla3.jpg" alt="">
        </div>
    </div>
