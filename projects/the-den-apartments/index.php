<?php $description = 'The Den Apartments design by Arctic Mirage'; ?>
<?php $keywords = 'The Den Apartments, The den, Den Apartments'; ?>
<?php $title = 'The Den Apartments | Arctic Mirage'; include("../../includes/header.php"); ?>
    <div class="pr-desc">
    <h1>The Den Apartments</h1>
<p>3D Artist Impressions</p>
</div>
    <div id="content_1" class="content">
        <div class="images_container">
            <img src="Den1.jpg" alt="">
            <img src="Den2.jpg" alt="">
            <img src="Den3.jpg" alt="">
        </div>
    </div>
