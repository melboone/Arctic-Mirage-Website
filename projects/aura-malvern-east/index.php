<?php $description = 'Aura Malvern East'; ?>
<?php $keywords = 'Aura Malvern East'; ?>
<?php $title = 'Aura Malvern East | Arctic Mirage'; include("../../includes/header.php"); ?>
    <div class="pr-desc">
    <h1>Aura Malvern East</h1>
<p>Logo Design<br>
Location Map<br>
Aerial Photo<br>
...
Display Suite Graphic<br>s
Hoarding Banner<br>
Website</p>
</div>
    <div id="content_1" class="content">
        <div class="images_container">
            <img src="aura-malvern-east-1.jpg" alt="">
            <img src="aura-malvern-east-2.jpg" alt="">
            <img src="aura-malvern-east-3.jpg" alt="">
            <img src="aura-malvern-east-4.jpg" alt="">
            <img src="aura-malvern-east-5.jpg" alt="">
            <img src="aura-malvern-east-6.jpg" alt="">
        </div>
    </div>
