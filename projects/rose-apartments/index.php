<?php $description = 'Rose Apartments'; ?>
<?php $keywords = 'Rose Apartments'; ?>
<?php $title = 'Rose Apartments | Arctic Mirage'; include("../../includes/header.php"); ?>
    <div class="pr-desc">
    <h1>Rose Apartments</h1>
...
Lifestyle Images</p>
    ...
    <div id="content_1" class="content">
        <div class="images_container">
            <img src="rose-1.jpg" alt="">
            <img src="rose-2.jpg" alt="">
            <img src="rose-3.jpg" alt="">
            <img src="rose-4.jpg" alt="">
            <img src="rose-5.jpg" alt="">
            <img src="rose-6.jpg" alt="">
        </div>
    </div>
