<?php $description = 'Norfolk Apartments design by Arctic Mirage Melbourne'; ?>
<?php $keywords = 'norfolk Apartments'; ?>
<?php $title = 'Norfolk Apartments | Arctic Mirage'; include("../../includes/header.php"); ?>
    <div class="pr-desc">
    <h1>The Norfolk Apartments</h1>
<p>Website<br>
Leaflet Design
</p>
</div>
    <div id="content_1" class="content">
        <div class="images_container">
            <img src="Norfolk1.jpg" alt="">
             <img src="Norfolk2.jpg" alt="">
        </div>
    </div>
