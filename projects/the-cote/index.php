<?php $description = 'The Cote by Arctic Mirage Melbourne'; ?>
<?php $keywords = 'the cote, cote'; ?>
<?php $title = 'The Cote | Arctic Mirage'; include("../../includes/header.php"); ?>
    <div class="pr-desc">
    <h1>The Cote</h1>
<p>Logo Design<br>
...
Location Map</p>
    ...
    <div id="content_1" class="content">
        <div class="images_container">
            <img src="TheCote1.jpg" alt="">
            <img src="TheCote2.jpg" alt="">
            <img src="TheCote3.jpg" alt="">
            <img src="TheCote4.jpg" alt="">
        </div>
    </div>
