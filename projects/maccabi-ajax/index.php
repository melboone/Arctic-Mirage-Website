<?php $description = 'Maccabi Ajax Cricket Club by Arctic Mirage Melbourne'; ?>
<?php $keywords = 'Maccabi Ajax Cricket Club, Maccabi Ajax, Cricket Club'; ?>
<?php $title = 'Maccabi Ajax Cricket Club | Arctic Mirage'; include("../../includes/header.php"); ?>
    <div class="pr-desc">
    <h1>Maccabi Ajax Cricket Club</h1>
<p>EDM<br>
Leaflet Design</p>
</div>
    <div id="content_1" class="content">
        <div class="images_container">
            <img src="Maccabi1.jpg" alt="">
            <img src="Maccabi2.jpg" alt="">
        </div>
    </div>
