<?php $description = 'Virage Mosman'; ?>
<?php $keywords = 'Virage Mosman'; ?>
<?php $title = 'Virage Mosman | Arctic Mirage'; include("../../includes/header.php"); ?>
    <div class="pr-desc">
    <h1>Virage Mosman</h1>
<p>Logo Design<br>
Brochure Design<br>
...
Hoarding Banner<br>
Marketing Floor Plan</p>
</div>
    <div id="content_1" class="content">
        <div class="images_container">
            <img src="Virage1.jpg" alt="">
            <img src="Virage2.jpg" alt="">
        </div>
    </div>
