<?php $description = 'The Mantle by Arctic Mirage Melbourne'; ?>
<?php $keywords = 'Mantle Apartments'; ?>
<?php $title = 'The Mantle | Arctic Mirage'; include("../../includes/header.php"); ?>
    <div class="pr-desc">
    <h1>The Mantle</h1>
<p>Interior Specifications<br>
    3D Artist Impressions</p>
</div>
    <div id="content_1" class="content">
        <div class="images_container">
            <img src="TheMantle1.jpg" alt="">
            <img src="TheMantle2.jpg" alt="">
        </div>
    </div>
