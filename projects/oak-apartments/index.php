<?php $description = 'Oak apartments by Arctic Mirage'; ?>
<?php $keywords = 'Oak apartments'; ?>
<?php $title = 'Oak Apartments | Arctic Mirage'; include("../../includes/header.php"); ?>
    <div class="pr-desc">
...
Website</p>
    ...
    <div id="content_1" class="content">
        <div class="images_container">
            <img src="Oak1.jpg" alt="">
            <img src="Oak2.jpg" alt="">
            <img src="Oak3.jpg" alt="">
            <img src="Oak4.jpg" alt="">
            <img src="Oak5.jpg" alt="">
            <img src="Oak6.jpg" alt="">
            <img src="Oak7.jpg" alt="">
        </div>
    </div>
