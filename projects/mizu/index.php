<?php $description = 'Mizu design by Arctic Mirage Melbourne'; ?>
<?php $keywords = 'Mizu'; ?>
<?php $title = 'Mizu | Arctic Mirage'; include("../../includes/header.php"); ?>
    <div class="pr-desc">
    <h1>Mizu</h1>
...
Hoarding Banner<br></p>
</div>
    <div id="content_1" class="content">
        <div class="images_container">
            <img src="TAM_WebFolio_96.jpg" alt="">
            <img src="TAM_WebFolio_97.jpg" alt="">
            <img src="TAM_WebFolio_98.jpg" alt="">
            <img src="TAM_WebFolio_99.jpg" alt="">
            <img src="TAM_WebFolio_100.jpg" alt="">
            <img src="TAM_WebFolio_101.jpg" alt="">
            <img src="TAM_WebFolio_102.jpg" alt="">
        </div>
    </div>
