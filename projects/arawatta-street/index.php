<?php $description = 'Arawatta Street by Arctic Mirage'; ?>
<?php $keywords = 'Arawatta Street, Arawatta'; ?>
<?php $title = 'Arawatta Street | Arctic Mirage'; include("../../includes/header.php"); ?>
    <div class="pr-desc">
    <h1>Arawatta Street</h1>
<p>3D Artist Impressions</p>
</div>
    <div id="content_1" class="content">
        <div class="images_container">
            <img src="Arawatta1.jpg" alt="">
            <img src="Arawatta2.jpg" alt="">
            <img src="Arawatta3.jpg" alt="">
            <img src="Arawatta4.jpg" alt="">
            <img src="Arawatta5.jpg" alt="">
        </div>
    </div>
