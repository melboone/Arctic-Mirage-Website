<?php $description = 'The aspendale design by Arctic Mirage Melbourne'; ?>
<?php $keywords = 'The Aspendale, aspendale'; ?>
<?php $title = 'The Aspendale | Arctic Mirage'; include("../../includes/header.php"); ?>
    <div class="pr-desc">
    <h1>The Aspendale</h1>
<p>Interior Specifications<br>
3D Artist Impressions<br>
Physical Material Board</p>
</div>
    <div id="content_1" class="content">
        <div class="images_container">
            <img src="Aspendale1.jpg" alt="">
            <img src="Aspendale2.jpg" alt="">
            <img src="Aspendale3.jpg" alt="">
        </div>
    </div>
