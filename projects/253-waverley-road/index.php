<?php $description = '253 Waverley Road by Arctic Mirage'; ?>
<?php $keywords = '253 waverley road, waverley road'; ?>
<?php $title = '253 Waverley Road | Arctic Mirage'; include("../../includes/header.php"); ?>
    <div class="pr-desc">
    <h1>253 Waverley Road</h1>
<p>3D Artist Impressions<br>
Marketing Floor Plans</p>
</div>
    <div id="content_1" class="content">
        <div class="images_container">
            <img src="253Waverley1.jpg" alt="">
            <img src="253Waverley2.jpg" alt="">
            <img src="253Waverley3.jpg" alt="">
            <img src="253Waverley4.jpg" alt="">
        </div>
    </div>
