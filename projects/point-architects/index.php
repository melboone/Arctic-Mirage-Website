<?php $description = 'Point Architect by Arctic Mirage'; ?>
<?php $keywords = 'Point Architects'; ?>
<?php $title = 'Point Architect | Arctic Mirage'; include("../../includes/header.php"); ?>
    <div class="pr-desc">
    <h1>Point Architects</h1>
<p>Brochure Design</p>
</div>
    <div id="content_1" class="content">
        <div class="images_container">
            <img src="PointArc1.jpg" alt="">
            <img src="PointArc2.jpg" alt="">
            <img src="PointArc3.jpg" alt="">
            <img src="PointArc4.jpg" alt="">
            <img src="PointArc5.jpg" alt="">
        </div>
    </div>
