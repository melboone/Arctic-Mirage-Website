<?php $description = 'St Lukes'; ?>
<?php $keywords = 'St Lukes'; ?>
<?php $title = 'St Lukes | Arctic Mirage'; include("../../includes/header.php"); ?>
    <div class="pr-desc">
    <h1>St Lukes</h1>
...
Lifestyle Images</p>
    ...
    <div id="content_1" class="content">
        <div class="images_container">
            <img src="st-lukes-1.jpg" alt="">
            <img src="st-lukes-2.jpg" alt="">
            <img src="st-lukes-3.jpg" alt="">
            <img src="st-lukes-4.jpg" alt="">
            <img src="st-lukes-5.jpg" alt="">
            <img src="st-lukes-6.jpg" alt="">
            <img src="st-lukes-7.jpg" alt="">
        </div>
    </div>
