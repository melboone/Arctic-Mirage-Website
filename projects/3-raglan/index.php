<?php $description = '3 Raglan Street by Arctic Mirage'; ?>
<?php $keywords = 'Raglan street, 3 raglan, raglan street'; ?>
<?php $title = '3 Raglan Street | Arctic Mirage'; include("../../includes/header.php"); ?>
    <div class="pr-desc">
    <h1>3 Raglan</h1>
...
Website</p>
    ...
    <div id="content_1" class="content">
        <div class="images_container">
            <img src="3raglan1.jpg" alt="">
            <img src="3raglan2.jpg" alt="">
            <img src="3raglan3.jpg" alt="">
            <img src="3raglan4.jpg" alt="">
        </div>
    </div>
