<?php $description = 'Prism Apartments'; ?>
<?php $keywords = 'Prism Apartments'; ?>
<?php $title = 'Prism Apartments | Arctic Mirage'; include("../../includes/header.php"); ?>
    <div class="pr-desc">
    <h1>Prism Apartments</h1>
...
Lifestyle Images</p>
    ...
    <div id="content_1" class="content">
        <div class="images_container">
            <img src="prism-apartments-1.jpg" alt="">
            <img src="prism-apartments-2.jpg" alt="">
            <img src="prism-apartments-3.jpg" alt="">
            <img src="prism-apartments-4.jpg" alt="">
            <img src="prism-apartments-5.jpg" alt="">
        </div>
    </div>
